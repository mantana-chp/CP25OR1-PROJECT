...
export type CreateHealthLogPayload = z.infer<typeof createHealthLogSchema>['body'];
export type UpdateHealthLogPayload = z.infer<typeof updateHealthLogSchema>['body'];
